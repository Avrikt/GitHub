...
* Date: 07.03.23							*
* Description: Header file for FSA			*
*********************************************/

#ifndef MY_PROJECT_FSA_H__
#define MY_PROJECT_FSA_H__
...
*	block_size - minimun number of bytes for each block. if the size is 0, the behaviior is undefined
*
* @Returns:
