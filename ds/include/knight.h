...
* Date: 20.04.2023							*
* Description: Header file for knight		*
*********************************************/

#ifndef MY_PROJECT_Knight_H__
#define MY_PROJECT_Knight_H__
...
* 
* @return:
*   Returns - if there is a valid soultion return 0, else return non zero.
*
* complexity
*	Time: O(8^n).
*	Space O(1)
