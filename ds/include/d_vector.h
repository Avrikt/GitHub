/***********Dynamic_Vector_data_structure***********/

#ifndef MY_PROJECT_D_VECTOR_H__
#define MY_PROJECT_D_VECTOR_H__
...
*	In case of reallocation failure - the element will still be pushed to the vector. 
*
* @param:
...
*
* @param:
*	vector - The vector to check its capacity 
*
* @Return
