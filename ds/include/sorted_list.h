...
#ifndef MY_PROJECT_SORTED_LIST_H__
#define MY_PROJECT_SORTED_LIST_H__
...
*
* @param:
* 	function - pointer to a compare function which adheres to the temlpate 'int user_func(const void *data1, const void *data2)'
*
* @return:
